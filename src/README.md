...
│   ├── data_fetch.py         # market data collection
│   ├── data_clean.py         # cleaning, no-arbitrage flags, spot/T calculation
│   ├── pricing_engine.py     # BSM pricing, Greeks, no-arbitrage bounds
│   ├── implied_vol.py        # implied volatility solver
│   └── var_module.py         # Parametric and Historical Simulation VaR
├── requirements.txt
└── README.md
```
...
```bash
git clone https://github.com/yourusername/nifty-derivatives-dashboard.git
...
**Group 6** — Financial Derivatives and Risk Management
- Aditya Pratap Singh (25SF02)
- Fia Theresa Sabu (25SF018)
